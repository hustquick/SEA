...
\begin{figure}[htbp]
	\centering
	\gnuplotloadfile[terminal=epslatex, terminaloptions=color dashed]{T_ih.gnuplot}
	\caption{Influence of $T_{i,h}$ on efficiency and power of SEA}
	\label{fig:T_ih}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\gnuplotloadfile[terminal=epslatex, terminaloptions=color dashed]{q_mhcp_h.gnuplot}
	\caption{Influence of $q_{m,h}c_{p,h}$ on efficiency and power of SEA}
	\label{fig:qm_hcp_h}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\gnuplotloadfile[terminal=epslatex, terminaloptions=color dashed]{q_mccp_c.gnuplot}
...
\begin{figure}[htbp]
	\centering
	\gnuplotloadfile[terminal=epslatex, terminaloptions=color dashed]{n_se.gnuplot}
	\caption{Influence of $n_{se}$ on efficiency and power of SEA}
	\label{fig:n_se}
\end{figure}
