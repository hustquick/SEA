...
\begin{table*}[htbp]\footnotesize
	\caption{Comparing the thermal efficiency of the proposed Stirling engine model, previous thermal models and experimental data at various engine-operating models($T_{hw}=922\,\mathrm{K}$ and $T_{cw}=288\,\mathrm{K}$)}
	\begin{center}
...
\begin{table*}[htbp]\footnotesize
	\caption{Comparing the output power of the proposed Stirling engine model, previous thermal models and experimental data at various engine-operating models($T_{hw}=922\,\mathrm{K}$ and $T_{cw}=288\,\mathrm{K}$)}
	\begin{center}
	\begin{tabular}{cccccccccccc}
		\toprule
